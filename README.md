...
By default, this should be pom and jars.

# Purpose
Need to check all files presence in repository. Commonly, it is a boring action
...
# Functionality
- allow specify required modules with names, versions and submodules; 
